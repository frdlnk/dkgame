...
public class Helicoptero extends Enemigo {
	...
	/**
	 * Logica de control para el arrojo de bombvas y cantidad de bombardeos por
	 * tiempo
	 */
	...
	public ColisionInfo hayColision(Colisionable entidad) {
		...
		// si colisiona con el cuerpo principal no se bombardea y se actua con la
		// colision natural del Enemigo
		if (colision != null) {
			return colision;
		}
		// si hay una colision con el collider de bombardeo y el jugador emppieza el
		// bombardeo
