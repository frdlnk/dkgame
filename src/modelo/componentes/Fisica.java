 ...
 * 
 * Esta clase se encarga de calcuylar el siguiente movimiento de un objeto segun
 * las fuerzas aplicadas, realizando el calculo en base a su masa y escala de
 * gravedad
 * 
 * Puede generar friccion y aceleracion
 * 
 * @implNote El indice de gravedad es la cantidad de efecto que tiene la
 *           constante gravedad sobre un objeto Para eliminar la gravedad de un
 *           objeto setea la gravedad de este objeto a 0
 * @implNote Si desea una fisica mas realista en objetos complejos use transform
 *           relativos al transforma asignado al componente
 * 
...
public class Fisica extends Physics {
	...
	/**
	 * Crea una nueva Fisica con la masa, y gravedad especificadas y el trasnform
	 * asociado
	 * 
	 * @implNote la escala de gravedad no define la gravedad del mundo si no la
	 *           magnituid <br>
	 *           en la que la gravedad del mundo {@value Conf#GRAVITY} afecta este
	 *           objeto
	 * 
	...
	/**
	 * Acelera un objeto con un {@link Movement} asociado {@link Deprecated}
	 * reemplazado por {@link #acelerar()}
	 */
	@Override
	@Deprecated
