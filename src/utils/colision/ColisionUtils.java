...
public class ColisionUtils {
	/**
	 * Verifica la colision entre 2 objetos y decide cuales deben desencadenar
	 * onColision
	 * 
	 * @param col1 objeto 1
	 * @param col2 objeto 2
	...
	public static void colisionResolve(Colisionable col1, Colisionable col2) {
		...
		else if (col2Colisiona != null && col2Colisiona.isTriger() && col1Colisiona != null
				&& !col1Colisiona.isTriger())
	 ...
	 * @param colisionable
	 */
	public static void entityColisionVerifier(ListaEntidades lista, Colisionable colisionable) {
