...
public class UserFieldsValidator {
	...
	/**
	 * Construye un nuevo validador para los adtos de usuario con el modelo
	 * especificado
	 * 
	...
	/**
	 * Valida que un string que contiene la contrasena de usuario <br>
	 * cumpla con las siguientes condiciones
	 * <ul>
	 * <li>Longitud entre 4 y 10 caracteres</li>
	 * <li>No este vacia(por mensaje estetico ya que al validar la longitud esta
	 * implicito)</li>
	 ...
	 * </ul>
	 * 
	 * @implNote La comprobacion valores minimos regresa un mensaje completo para
	 *           una mejor compresion <br>
	...
	public String validatePassword(String password) {
		if (password == null || password.isEmpty()) {
			...
			/*
			 * regex valida que hayan al menos una mayuscula, una minuscula, 1 digito, 1
			 * caracter especial (?=.*\\d): un digito (?=.*[a-z]): una letra minuscula
			 * (?=.*[A-Z]): una mayuscula (?=.*\\W): un caracter especial .{4,}: cualquier
			 * caracter al menos 4 veces ^$: inicio y final de la cadena respectivamente
			 */
			return "<html>" + "<p>" + "La contrasena debe tener al menos 1 mayuscula, 1 miniscula,"
					+ "<br> 1 numero y 1 caracter especial" + "</p>" + "</html>";
		}
		// No hay errores
		return null;
	}
	...
	/**
	 * Valida un String con un nombre d usuario <br>
