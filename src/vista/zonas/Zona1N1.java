...
/**
 * Zona correspondiente al nivel 1, cuenta con 3 jefes, y cuenta con movimiento
 * de camara para el avance del escenario
 * 
 * 
...
public class Zona1N1 extends Zona {
	...
	private final Vector2D[] direccionChecpoints = { Vector2D.LEFT, Vector2D.LEFT, Vector2D.LEFT, new Vector2D(-1, .25),
			new Vector2D(-.5, .1), Vector2D.LEFT };
	...
	public String toString() {
		return "Zona1N1 [checkPoints=" + (checkPoints) + ", direccionChecpoints=" + (direccionChecpoints)
				+ ", actualCheckpoint=" + actualCheckpoint + ", barrier=" + barrier + ", background=" + background
				+ ", jefes=" + (jefes) + ", jefeActual=" + jefeActual + "]";
	}
